...
We'd love to have you contribute to numbat! Metrics are awesome and so are striped marsupials.

Please write unit tests for your contribution if you can, and make sure that any existing unit tests still pass. The command `npm run lint` will run a linter in all of the repos to help you catch errors as well.
